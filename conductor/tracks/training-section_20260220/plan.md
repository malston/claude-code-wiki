...
Final checks on `feature/training-section` integration branch. Training content may merge to main or move to its own repo -- decision pending.
...
- [x] Task 3.3: Commit final changes to `feature/training-section` integration branch

### Verification

- [x] Hugo production build succeeds without errors
- [x] All acceptance criteria from spec.md are met
- [x] Content reviewed -- staying on integration branch for now
...
- [x] Decision: keep on integration branch (`feature/training-section`)
