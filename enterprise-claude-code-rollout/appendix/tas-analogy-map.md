# TAS to Claude Code Analogy Map

For consultants coming from a Tanzu Application Service / Cloud Foundry background, these analogies help translate platform engineering concepts into the Claude Code domain.

## Core Concept Mapping

| TAS / Cloud Foundry | Claude Code | Explanation |
|---|---|---|
